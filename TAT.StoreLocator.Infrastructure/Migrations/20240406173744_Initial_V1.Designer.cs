...
namespace TAT.StoreLocator.Infrastructure.Migrations
{
    ...
    [Migration("20240406173744_Initial_V1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TAT.StoreLocator.Core.Entities.Brand", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");

                    b.Property<string>("BrandNameSearch")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("TAT.StoreLocator.Core.Entities.Location", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("TAT.StoreLocator.Core.Entities.Location", b =>
                {
                    b.HasOne("TAT.StoreLocator.Core.Entities.Address", "Address")
                        .WithOne("Location")
                        .HasForeignKey("TAT.StoreLocator.Core.Entities.Location", "AddressId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("TAT.StoreLocator.Core.Entities.Product", b =>
                {
                    b.HasOne("TAT.StoreLocator.Core.Entities.Brand", "Brand")
                        .WithMany("Products")
