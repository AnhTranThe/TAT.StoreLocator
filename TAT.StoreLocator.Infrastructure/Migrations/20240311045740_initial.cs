        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            _ = migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    IsDiscountAllowed = table.Column<bool>(type: "boolean", nullable: false),
            ...
            _ = migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    _ = table.PrimaryKey("PK_MapProductGalleries", x => x.Id);
                    _ = table.ForeignKey(
                        name: "FK_MapProductGalleries_Galleries_GalleryId",
                        column: x => x.GalleryId,
                        principalTable: "Galleries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    _ = table.ForeignKey(
                        name: "FK_MapProductGalleries_Products_ProductId",
            ...
            _ = migrationBuilder.CreateIndex(
                name: "IX_MapProductGalleries_GalleryId",
                table: "MapProductGalleries",
                column: "GalleryId");

            _ = migrationBuilder.CreateIndex(
                name: "IX_MapProductGalleries_ProductId",
                table: "MapProductGalleries",
                column: "ProductId");
